 ...
 */
@Entity
@Table(name = "grid_robot_backtests")
@Data
@EntityListeners(AuditingEntityListener.class)
public class GridRobotBacktest {
    @Id
    ...
    private String backtestParams; // JSON格式存储回测参数

    @Column(name = "equity_curve_data", columnDefinition = "TEXT")
    private String equityCurveData; // 权益曲线数据（JSON格式）
