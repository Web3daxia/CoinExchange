 ...
 */
@Entity
@Table(name = "leveraged_trading_pairs")
@Data
@EntityListeners(AuditingEntityListener.class)
public class LeveragedTradingPair {
    @Id
    ...
    @Column(name = "interest_settlement_cycle")
    private Integer interestSettlementCycle; // 利息结算周期（小时）
    ...
    private BigDecimal maxQuantity; // 最大数量
