...
/**
 * 币安币本位永续合约市场数据适配器
 * API文档: https://binance-docs.github.io/apidocs/delivery/cn/
 * 币本位永续合约API基础地址: https://dapi.binance.com/dapi/v1
 */
@Component
public class BinanceCoinFuturesMarketDataAdapter implements CoinFuturesMarketDataAdapter {
    ...
    // 币安币本位永续合约API基础地址
    private static final String BINANCE_COIN_FUTURES_API_BASE = "https://dapi.binance.com/dapi/v1";

    @Override
    public String convertSymbol(String pairName) {
        // BTC/BTC -> BTCUSD_PERP (币本位永续合约使用USD_PERP后缀)
        // 简化处理：BTC/BTC -> BTCUSD_PERP
    ...
    public Map<String, Object> get24hrTicker(String symbol) {
        try {
            // 币安币本位永续合约24小时价格变动统计: GET /dapi/v1/ticker/24hr
            String url = BINANCE_COIN_FUTURES_API_BASE + "/ticker/24hr?symbol=" + symbol;
            ...
            throw new RuntimeException("获取币安币本位永续合约24小时统计数据失败: " + e.getMessage(), e);
        }
    }
    ...
    public Map<String, Object> getDepth(String symbol, Integer limit) {
        try {
            // 币安币本位永续合约订单簿: GET /dapi/v1/depth
            String url = BINANCE_COIN_FUTURES_API_BASE + "/depth?symbol=" + symbol + "&limit=" + limit;
            String response = restTemplate.getForObject(url, String.class);
            Map<String, Object> data = objectMapper.readValue(response, new TypeReference<Map<String, Object>>() {});
            ...
            throw new RuntimeException("获取币安币本位永续合约市场深度失败: " + e.getMessage(), e);
        }
    }
    ...
    public List<Map<String, Object>> getKlineData(String symbol, String interval, Integer limit) {
        try {
            ...
            // 币安币本位永续合约K线数据: GET /dapi/v1/klines
            String url = BINANCE_COIN_FUTURES_API_BASE + "/klines?symbol=" + symbol + "&interval=" + binanceInterval + "&limit=" + limit;
            String response = restTemplate.getForObject(url, String.class);
            ...
            for (List<Object> kline : klines) {
                // 币安币本位永续合约K线数据格式: [openTime, open, high, low, close, volume, closeTime, ...]
                Map<String, Object> item = new HashMap<>();
            ...
            throw new RuntimeException("获取币安币本位永续合约K线数据失败: " + e.getMessage(), e);
        }
    }
    ...
    public Map<String, Object> getMarkPriceAndIndexPrice(String symbol) {
        try {
            // 币安币本位永续合约标记价格和指数价格: GET /dapi/v1/premiumIndex
            String url = BINANCE_COIN_FUTURES_API_BASE + "/premiumIndex?symbol=" + symbol;
            String response = restTemplate.getForObject(url, String.class);
            Map<String, Object> data = objectMapper.readValue(response, new TypeReference<Map<String, Object>>() {});
            ...
            throw new RuntimeException("获取币安币本位永续合约标记价格和指数价格失败: " + e.getMessage(), e);
        }
    }
    ...
    public BigDecimal getFundingRate(String symbol) {
        try {
            // 币安币本位永续合约当前资金费率: GET /dapi/v1/premiumIndex
            String url = BINANCE_COIN_FUTURES_API_BASE + "/premiumIndex?symbol=" + symbol;
            String response = restTemplate.getForObject(url, String.class);
            Map<String, Object> data = objectMapper.readValue(response, new TypeReference<Map<String, Object>>() {});
            ...
            throw new RuntimeException("获取币安币本位永续合约资金费率失败: " + e.getMessage(), e);
        }
    }

    private String convertInterval(String interval) {
        // 转换时间粒度: 币安币本位永续合约支持的时间粒度
