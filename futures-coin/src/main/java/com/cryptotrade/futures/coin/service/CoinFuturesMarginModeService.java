...
public interface CoinFuturesMarginModeService {
    /**
     * 设置保证金模式
     */
     ...
     * @return 可用保证金（基础资产，如BTC）
     */
    BigDecimal calculateMargin(Long userId, String pairName, BigDecimal positionQuantity, BigDecimal price, 
