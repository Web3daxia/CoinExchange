 ...
 */
@ApiModel("币本位合约计算器请求")
public class CoinFuturesCalculatorRequest {
    
    @ApiModelProperty(value = "交易对", required = true, example = "BTC/USD")
    ...
    @ApiModelProperty(value = "合约面值", example = "100.00000000")
    private BigDecimal faceValue = new BigDecimal("100");
    
    @ApiModelProperty(value = "合约乘数", example = "0.00010000")
    private BigDecimal contractMultiplier = new BigDecimal("0.0001");
    ...
    @ApiModelProperty(value = "保证金余额（逐仓模式必填，单位为基础币种，如BTC）", example = "0.00200000")
