 ...
 */
@ApiModel("币本位合约计算器响应")
public class CoinFuturesCalculatorResponse {
    
    @ApiModelProperty(value = "初始保证金（单位为基础币种，如BTC）")
    private BigDecimal initialMargin;
    
    @ApiModelProperty(value = "维持保证金（单位为基础币种，如BTC）")
    private BigDecimal maintenanceMargin;
    
    @ApiModelProperty(value = "未实现盈亏（单位为基础币种，如BTC）")
