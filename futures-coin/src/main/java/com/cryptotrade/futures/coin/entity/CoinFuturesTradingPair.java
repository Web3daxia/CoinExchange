 ...
 */
@Entity
@Table(name = "coin_futures_trading_pairs")
@Data
@EntityListeners(AuditingEntityListener.class)
public class CoinFuturesTradingPair {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;

    @Column(name = "pair_name", unique = true, nullable = false)
    private String pairName; // 交易对名称，如: LINK/BTC
    ...
    private String leverageMultipliers; // 杠杆倍数，如: 5,10,20,50,100
    ...
    private String contractType = "COIN_MARGINED"; // 合约类型: COIN_MARGINED（币本位）
